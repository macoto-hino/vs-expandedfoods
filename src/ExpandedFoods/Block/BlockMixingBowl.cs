        ...
        public override WorldInteraction[] GetPlacedBlockInteractionHelp(IWorldAccessor world, BlockSelection selection, IPlayer forPlayer)
        {
            ...
            else
            {
                return new WorldInteraction[] {
                    new WorldInteraction()
                    {
                        ActionLangCode = "expandedfoods:blockhelp-mixingbowl-mix",
                        MouseButton = EnumMouseButton.Right,
                    ...
                    new WorldInteraction()
                    {
                        ActionLangCode = "expandedfoods:blockhelp-mixingbowl-autounlock",
                        MouseButton = EnumMouseButton.Right,
                        HotKeyCode = "sprint",
                        ShouldApply = (wi, bs, es) => {
                            BlockEntityMixingBowl beBowl = world.BlockAccessor.GetBlockEntity(bs.Position) as BlockEntityMixingBowl;
                    ...
                    new WorldInteraction()
                    {
                        ActionLangCode = "expandedfoods:blockhelp-mixingbowl-autolock",
                        MouseButton = EnumMouseButton.Right,
                        HotKeyCode = "sprint",
                        ShouldApply = (wi, bs, es) => {
                            BlockEntityMixingBowl beBowl = world.BlockAccessor.GetBlockEntity(bs.Position) as BlockEntityMixingBowl;
