...
namespace ExpandedFoods
{
    public class ItemExpandedFood : ItemExpandedRawFood
    {
        ...
        public override void GetHeldItemInfo(ItemSlot inSlot, StringBuilder dsc, IWorldAccessor world, bool withDebugInfo)
        {
            ...
            {
                dsc.AppendLine(Lang.Get("expandedfoods:Extra Nutrients"));
                ...
                foreach (FoodNutritionProperties props in addProps)
                {
                    ...
                    {
                        dsc.AppendLine(Lang.Get("expandedfoods:- {0} {2} sat, {1} hp", Math.Round(props.Satiety * satLossMul), props.Health * healthLossMul, props.FoodCategory.ToString()));
                    }
                    else
                    {
                        dsc.AppendLine(Lang.Get("expandedfoods:- {0} {1} sat", Math.Round(props.Satiety * satLossMul), props.FoodCategory.ToString()));
                    }
                }
            }
